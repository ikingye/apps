...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/apps/flexsearch.min.js');loadScript('/apps/en.search-data.min.669d561ee28040a8d7fdfaa5910f96bb902574b6738f87d65b781cad8cb0afcc.js',function(){input.required=false;search();});}
