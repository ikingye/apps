...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/apps/flexsearch.min.js');loadScript('/apps/en.search-data.min.b5eb54719f55c11bee3546bd708f40fa9384d98fe0840a255f21bfba4d3881af.js',function(){input.required=false;search();});}
